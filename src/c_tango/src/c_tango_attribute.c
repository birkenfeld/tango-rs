...
ErrorStack *tango_get_attribute_list(void *proxy, VarStringArray *attr_names) {
    ...
    try {
        ...
        for (int i = 0; i < nb_data; i++) {
            ...
            strcpy(attr_names->sequence[i], (*attr_list)[i].c_str());
        }
        delete attr_list;
    }
    catch (Tango::DevFailed &tango_exception) {
...
void convert_attribute_reading(Tango::DeviceAttribute& devattr, AttributeData *argout) {
    ...
    if (devattr.get_quality() == Tango::ATTR_INVALID) {
        ...
        case DEV_BOOLEAN: {
            ...
            memcpy(argout->attr_data.bool_arr.sequence, bool_seq->get_buffer(),
                   (sizeof(bool) * nb_data));
        ...
        case DEV_UCHAR: {
            ...
            memcpy(argout->attr_data.char_arr.sequence, char_seq->get_buffer(),
        ...
        case DEV_SHORT: {
            ...
            memcpy(argout->attr_data.short_arr.sequence, short_seq->get_buffer(),
        ...
        case DEV_USHORT: {
            ...
            memcpy(argout->attr_data.ushort_arr.sequence, ushort_seq->get_buffer(),
        ...
        case DEV_LONG: {
            ...
            memcpy(argout->attr_data.long_arr.sequence, long_seq->get_buffer(),
                   (sizeof(int) * nb_data));
        ...
        case DEV_ULONG: {
            ...
            memcpy(argout->attr_data.ulong_arr.sequence, ulong_seq->get_buffer(),
        ...
        case DEV_LONG64: {
            ...
            memcpy(argout->attr_data.long64_arr.sequence, long64_seq->get_buffer(),
        ...
        case DEV_ULONG64: {
            ...
            memcpy(argout->attr_data.ulong64_arr.sequence, ulong64_seq->get_buffer(),
        ...
        case DEV_FLOAT: {
            ...
            memcpy(argout->attr_data.float_arr.sequence, float_seq->get_buffer(),
        ...
        case DEV_DOUBLE: {
            ...
            memcpy(argout->attr_data.double_arr.sequence, double_seq->get_buffer(),
        ...
        case DEV_STRING: {
            ...
            for (int i=0 ; i<nb_data ; i++) {
                ...
                strcpy(argout->attr_data.string_arr.sequence[i],
                       string_vect[i].c_str());
            }
            break;
        }
        ...
        case DEV_ENCODED: {
            ...
            for (int i=0 ; i<nb_data ; i++) {
                ...
                strcpy(argout->attr_data.encoded_arr.sequence[i].encoded_format, format.c_str());
