...
ErrorStack *tango_command_inout(void *proxy, char *cmd_name, CommandData *argin, CommandData *argout) {
    ...
    try {
        ...
        case DEVVAR_CHARARRAY: {
            ...
            memcpy(argout->cmd_data.char_arr.sequence, char_seq->get_buffer(),
        ...
        case DEVVAR_SHORTARRAY: {
            ...
            memcpy(argout->cmd_data.short_arr.sequence, short_seq->get_buffer(),
        ...
        case DEVVAR_USHORTARRAY: {
            ...
            memcpy(argout->cmd_data.ushort_arr.sequence, ushort_seq->get_buffer(),
        ...
        case DEVVAR_LONGARRAY: {
            ...
            memcpy(argout->cmd_data.long_arr.sequence, long_seq->get_buffer(),
                   (sizeof(int) * nb_data));
            break;
        }
        ...
        case DEVVAR_ULONGARRAY: {
            ...
            memcpy(argout->cmd_data.ulong_arr.sequence, ulong_seq->get_buffer(),
        ...
        case DEVVAR_LONG64ARRAY: {
            ...
            memcpy(argout->cmd_data.long64_arr.sequence, long64_seq->get_buffer(),
        ...
        case DEVVAR_ULONG64ARRAY: {
            ...
            memcpy(argout->cmd_data.ulong64_arr.sequence, ulong64_seq->get_buffer(),
        ...
        case DEVVAR_FLOATARRAY: {
            ...
            memcpy(argout->cmd_data.float_arr.sequence, float_seq->get_buffer(),
        ...
        case DEVVAR_DOUBLEARRAY: {
            ...
            memcpy(argout->cmd_data.double_arr.sequence, double_seq->get_buffer(),
        ...
        case DEVVAR_STRINGARRAY: {
            ...
            for (int i=0 ; i<nb_data ; i++) {
                ...
                strcpy(argout->cmd_data.string_arr.sequence[i], string_vect[i].c_str());
            }
            break;
        }
        ...
        case DEVVAR_LONGSTRINGARRAY: {
            ...
            for (int i=0 ; i<nb_data ; i++) {
                ...
                strcpy(argout->cmd_data.long_string_arr.string_sequence[i],
                       string_vect[i].c_str());
            }
            break;
        }
        ...
        case DEVVAR_DOUBLESTRINGARRAY: {
            ...
            for (int i=0 ; i<nb_data ; i++) {
                ...
                strcpy(argout->cmd_data.double_string_arr.string_sequence[i],
                       string_vect[i].c_str());
            }
            break;
        }
...
static void convert_cmd_query(Tango::CommandInfo& tango_cmd_info, CommandInfo *cmd_info) {
    ...
    strcpy(cmd_info->cmd_name, tango_cmd_info.cmd_name.c_str());

    /* allocate command data descriptions */
    cmd_info->in_type_desc = new char[tango_cmd_info.in_type_desc.length() + 1];
    strcpy(cmd_info->in_type_desc, tango_cmd_info.in_type_desc.c_str());

    cmd_info->out_type_desc = new char[tango_cmd_info.out_type_desc.length() + 1];
    strcpy(cmd_info->out_type_desc, tango_cmd_info.out_type_desc.c_str());
